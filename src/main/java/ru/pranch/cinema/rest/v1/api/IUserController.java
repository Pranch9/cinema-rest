...
public interface IUserController {
  ...
  ResponseEntity<User> addUser(@RequestBody CreateUserDto createUserDto);

  @PutMapping(value = "/control/{id}", consumes = MediaType.APPLICATION_JSON_VALUE,
      produces = MediaType.APPLICATION_JSON_VALUE)
  ResponseEntity<User> editUser(@RequestBody CreateUserDto createUserDto, @PathVariable UUID id);
